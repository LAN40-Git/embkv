...
class Message final :
 ...
 public:
  ...
  enum : int {
    ...
    kRequestVoteReplyFieldNumber = 4,
  ...
  // .embkv.RequestVoteResponse request_vote_reply = 4;
  bool has_request_vote_reply() const;
  private:
  bool _internal_has_request_vote_reply() const;
  public:
  void clear_request_vote_reply();
  const ::embkv::RequestVoteResponse& request_vote_reply() const;
  PROTOBUF_NODISCARD ::embkv::RequestVoteResponse* release_request_vote_reply();
  ::embkv::RequestVoteResponse* mutable_request_vote_reply();
  void set_allocated_request_vote_reply(::embkv::RequestVoteResponse* request_vote_reply);
  private:
  const ::embkv::RequestVoteResponse& _internal_request_vote_reply() const;
  ::embkv::RequestVoteResponse* _internal_mutable_request_vote_reply();
  public:
  void unsafe_arena_set_allocated_request_vote_reply(
      ::embkv::RequestVoteResponse* request_vote_reply);
  ::embkv::RequestVoteResponse* unsafe_arena_release_request_vote_reply();
  ...
  // .embkv.AppendEntriesResponse append_entries_reply = 6;
  bool has_append_entries_reply() const;
  private:
  bool _internal_has_append_entries_reply() const;
  public:
  void clear_append_entries_reply();
  const ::embkv::AppendEntriesResponse& append_entries_reply() const;
  PROTOBUF_NODISCARD ::embkv::AppendEntriesResponse* release_append_entries_reply();
  ::embkv::AppendEntriesResponse* mutable_append_entries_reply();
  void set_allocated_append_entries_reply(::embkv::AppendEntriesResponse* append_entries_reply);
  private:
  const ::embkv::AppendEntriesResponse& _internal_append_entries_reply() const;
  ::embkv::AppendEntriesResponse* _internal_mutable_append_entries_reply();
  public:
  void unsafe_arena_set_allocated_append_entries_reply(
      ::embkv::AppendEntriesResponse* append_entries_reply);
  ::embkv::AppendEntriesResponse* unsafe_arena_release_append_entries_reply();
  ...
  // .embkv.InstallSnapshotResponse snapshot_reply = 8;
  bool has_snapshot_reply() const;
  private:
  bool _internal_has_snapshot_reply() const;
  public:
  void clear_snapshot_reply();
  const ::embkv::InstallSnapshotResponse& snapshot_reply() const;
  PROTOBUF_NODISCARD ::embkv::InstallSnapshotResponse* release_snapshot_reply();
  ::embkv::InstallSnapshotResponse* mutable_snapshot_reply();
  void set_allocated_snapshot_reply(::embkv::InstallSnapshotResponse* snapshot_reply);
  private:
  const ::embkv::InstallSnapshotResponse& _internal_snapshot_reply() const;
  ::embkv::InstallSnapshotResponse* _internal_mutable_snapshot_reply();
  public:
  void unsafe_arena_set_allocated_snapshot_reply(
      ::embkv::InstallSnapshotResponse* snapshot_reply);
  ::embkv::InstallSnapshotResponse* unsafe_arena_release_snapshot_reply();
  ...
  // .embkv.ClientResponse client_reply = 10;
  bool has_client_reply() const;
  private:
  bool _internal_has_client_reply() const;
  public:
  void clear_client_reply();
  const ::embkv::ClientResponse& client_reply() const;
  PROTOBUF_NODISCARD ::embkv::ClientResponse* release_client_reply();
  ::embkv::ClientResponse* mutable_client_reply();
  void set_allocated_client_reply(::embkv::ClientResponse* client_reply);
  private:
  const ::embkv::ClientResponse& _internal_client_reply() const;
  ::embkv::ClientResponse* _internal_mutable_client_reply();
  public:
  void unsafe_arena_set_allocated_client_reply(
      ::embkv::ClientResponse* client_reply);
  ::embkv::ClientResponse* unsafe_arena_release_client_reply();
 ...
 private:
  ...
  void set_has_request_vote_reply();
  ...
  struct Impl_ {
    ...
    union ContentUnion {
      ...
      ::embkv::RequestVoteResponse* request_vote_reply_;
      ::embkv::AppendEntriesRequest* append_entries_request_;
      ::embkv::AppendEntriesResponse* append_entries_reply_;
      ::embkv::InstallSnapshotRequest* snapshot_request_;
      ::embkv::InstallSnapshotResponse* snapshot_reply_;
      ::embkv::ClientRequest* client_request_;
      ::embkv::ClientResponse* client_reply_;
    } content_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
// .embkv.RequestVoteResponse request_vote_reply = 4;
inline bool Message::_internal_has_request_vote_reply() const {
  return content_case() == kRequestVoteReply;
}
inline bool Message::has_request_vote_reply() const {
  return _internal_has_request_vote_reply();
}
inline void Message::set_has_request_vote_reply() {
  _impl_._oneof_case_[0] = kRequestVoteReply;
}
inline void Message::clear_request_vote_reply() {
  if (_internal_has_request_vote_reply()) {
    if (GetArenaForAllocation() == nullptr) {
      delete _impl_.content_.request_vote_reply_;
    }
    clear_has_content();
  }
}
inline ::embkv::RequestVoteResponse* Message::release_request_vote_reply() {
  // @@protoc_insertion_point(field_release:embkv.Message.request_vote_reply)
  if (_internal_has_request_vote_reply()) {
    clear_has_content();
    ::embkv::RequestVoteResponse* temp = _impl_.content_.request_vote_reply_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.content_.request_vote_reply_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::embkv::RequestVoteResponse& Message::_internal_request_vote_reply() const {
  return _internal_has_request_vote_reply()
      ? *_impl_.content_.request_vote_reply_
      : reinterpret_cast< ::embkv::RequestVoteResponse&>(::embkv::_RequestVoteResponse_default_instance_);
}
inline const ::embkv::RequestVoteResponse& Message::request_vote_reply() const {
  // @@protoc_insertion_point(field_get:embkv.Message.request_vote_reply)
  return _internal_request_vote_reply();
}
inline ::embkv::RequestVoteResponse* Message::unsafe_arena_release_request_vote_reply() {
  // @@protoc_insertion_point(field_unsafe_arena_release:embkv.Message.request_vote_reply)
  if (_internal_has_request_vote_reply()) {
    clear_has_content();
    ::embkv::RequestVoteResponse* temp = _impl_.content_.request_vote_reply_;
    _impl_.content_.request_vote_reply_ = nullptr;
...
inline void Message::unsafe_arena_set_allocated_request_vote_reply(::embkv::RequestVoteResponse* request_vote_reply) {
  clear_content();
  if (request_vote_reply) {
    set_has_request_vote_reply();
    _impl_.content_.request_vote_reply_ = request_vote_reply;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:embkv.Message.request_vote_reply)
}
inline ::embkv::RequestVoteResponse* Message::_internal_mutable_request_vote_reply() {
  if (!_internal_has_request_vote_reply()) {
    clear_content();
    set_has_request_vote_reply();
    _impl_.content_.request_vote_reply_ = CreateMaybeMessage< ::embkv::RequestVoteResponse >(GetArenaForAllocation());
  }
  return _impl_.content_.request_vote_reply_;
}
inline ::embkv::RequestVoteResponse* Message::mutable_request_vote_reply() {
  ::embkv::RequestVoteResponse* _msg = _internal_mutable_request_vote_reply();
  // @@protoc_insertion_point(field_mutable:embkv.Message.request_vote_reply)
  return _msg;
}
...
inline ::embkv::AppendEntriesResponse* Message::release_append_entries_reply() {
  // @@protoc_insertion_point(field_release:embkv.Message.append_entries_reply)
  if (_internal_has_append_entries_reply()) {
    clear_has_content();
    ::embkv::AppendEntriesResponse* temp = _impl_.content_.append_entries_reply_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::embkv::AppendEntriesResponse& Message::_internal_append_entries_reply() const {
  return _internal_has_append_entries_reply()
...
inline const ::embkv::AppendEntriesResponse& Message::append_entries_reply() const {
  // @@protoc_insertion_point(field_get:embkv.Message.append_entries_reply)
  return _internal_append_entries_reply();
}
inline ::embkv::AppendEntriesResponse* Message::unsafe_arena_release_append_entries_reply() {
...
inline void Message::unsafe_arena_set_allocated_append_entries_reply(::embkv::AppendEntriesResponse* append_entries_reply) {
  clear_content();
...
inline ::embkv::AppendEntriesResponse* Message::_internal_mutable_append_entries_reply() {
  if (!_internal_has_append_entries_reply()) {
    clear_content();
    set_has_append_entries_reply();
    _impl_.content_.append_entries_reply_ = CreateMaybeMessage< ::embkv::AppendEntriesResponse >(GetArenaForAllocation());
  }
  return _impl_.content_.append_entries_reply_;
}
inline ::embkv::AppendEntriesResponse* Message::mutable_append_entries_reply() {
  ::embkv::AppendEntriesResponse* _msg = _internal_mutable_append_entries_reply();
...
inline ::embkv::InstallSnapshotResponse* Message::release_snapshot_reply() {
  // @@protoc_insertion_point(field_release:embkv.Message.snapshot_reply)
  if (_internal_has_snapshot_reply()) {
    clear_has_content();
    ::embkv::InstallSnapshotResponse* temp = _impl_.content_.snapshot_reply_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::embkv::InstallSnapshotResponse& Message::_internal_snapshot_reply() const {
  return _internal_has_snapshot_reply()
...
inline const ::embkv::InstallSnapshotResponse& Message::snapshot_reply() const {
  // @@protoc_insertion_point(field_get:embkv.Message.snapshot_reply)
  return _internal_snapshot_reply();
}
inline ::embkv::InstallSnapshotResponse* Message::unsafe_arena_release_snapshot_reply() {
...
inline void Message::unsafe_arena_set_allocated_snapshot_reply(::embkv::InstallSnapshotResponse* snapshot_reply) {
  clear_content();
  if (snapshot_reply) {
...
inline ::embkv::InstallSnapshotResponse* Message::_internal_mutable_snapshot_reply() {
  if (!_internal_has_snapshot_reply()) {
    clear_content();
    set_has_snapshot_reply();
    _impl_.content_.snapshot_reply_ = CreateMaybeMessage< ::embkv::InstallSnapshotResponse >(GetArenaForAllocation());
  }
  return _impl_.content_.snapshot_reply_;
}
inline ::embkv::InstallSnapshotResponse* Message::mutable_snapshot_reply() {
  ::embkv::InstallSnapshotResponse* _msg = _internal_mutable_snapshot_reply();
...
inline ::embkv::ClientResponse* Message::release_client_reply() {
  // @@protoc_insertion_point(field_release:embkv.Message.client_reply)
  if (_internal_has_client_reply()) {
    clear_has_content();
    ::embkv::ClientResponse* temp = _impl_.content_.client_reply_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline const ::embkv::ClientResponse& Message::_internal_client_reply() const {
  return _internal_has_client_reply()
      ? *_impl_.content_.client_reply_
      : reinterpret_cast< ::embkv::ClientResponse&>(::embkv::_ClientResponse_default_instance_);
}
inline const ::embkv::ClientResponse& Message::client_reply() const {
  // @@protoc_insertion_point(field_get:embkv.Message.client_reply)
  return _internal_client_reply();
}
inline ::embkv::ClientResponse* Message::unsafe_arena_release_client_reply() {
...
inline void Message::unsafe_arena_set_allocated_client_reply(::embkv::ClientResponse* client_reply) {
  clear_content();
  if (client_reply) {
...
inline ::embkv::ClientResponse* Message::_internal_mutable_client_reply() {
  if (!_internal_has_client_reply()) {
    clear_content();
    set_has_client_reply();
    _impl_.content_.client_reply_ = CreateMaybeMessage< ::embkv::ClientResponse >(GetArenaForAllocation());
  }
  return _impl_.content_.client_reply_;
}
inline ::embkv::ClientResponse* Message::mutable_client_reply() {
  ::embkv::ClientResponse* _msg = _internal_mutable_client_reply();
