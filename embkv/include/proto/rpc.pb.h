...
extern KVOperationDefaultTypeInternal _KVOperation_default_instance_;
class Message;
...
template<> ::embkv::KVOperation* Arena::CreateMaybeMessage<::embkv::KVOperation>(Arena*);
...
enum KVOperation_OperationType : int {
  KVOperation_OperationType_PUT = 0,
  KVOperation_OperationType_DELETE = 1,
  KVOperation_OperationType_GET = 2,
  KVOperation_OperationType_KVOperation_OperationType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  KVOperation_OperationType_KVOperation_OperationType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool KVOperation_OperationType_IsValid(int value);
constexpr KVOperation_OperationType KVOperation_OperationType_OperationType_MIN = KVOperation_OperationType_PUT;
constexpr KVOperation_OperationType KVOperation_OperationType_OperationType_MAX = KVOperation_OperationType_GET;
constexpr int KVOperation_OperationType_OperationType_ARRAYSIZE = KVOperation_OperationType_OperationType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* KVOperation_OperationType_descriptor();
template<typename T>
inline const std::string& KVOperation_OperationType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, KVOperation_OperationType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function KVOperation_OperationType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    KVOperation_OperationType_descriptor(), enum_t_value);
}
inline bool KVOperation_OperationType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, KVOperation_OperationType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<KVOperation_OperationType>(
    KVOperation_OperationType_descriptor(), name, value);
}
// ===================================================================
...
class KVOperation final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:embkv.KVOperation) */ {
 public:
  inline KVOperation() : KVOperation(nullptr) {}
  ~KVOperation() override;
  explicit PROTOBUF_CONSTEXPR KVOperation(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  KVOperation(const KVOperation& from);
  KVOperation(KVOperation&& from) noexcept
    : KVOperation() {
    *this = ::std::move(from);
  }

  inline KVOperation& operator=(const KVOperation& from) {
    CopyFrom(from);
    return *this;
  }
  inline KVOperation& operator=(KVOperation&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const KVOperation& default_instance() {
    return *internal_default_instance();
  }
  static inline const KVOperation* internal_default_instance() {
    return reinterpret_cast<const KVOperation*>(
               &_KVOperation_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    11;

  friend void swap(KVOperation& a, KVOperation& b) {
    a.Swap(&b);
  }
  inline void Swap(KVOperation* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(KVOperation* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  KVOperation* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<KVOperation>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const KVOperation& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const KVOperation& from);
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to, const ::PROTOBUF_NAMESPACE_ID::Message& from);
  public:
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(KVOperation* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "embkv.KVOperation";
  }
  protected:
  explicit KVOperation(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  typedef KVOperation_OperationType OperationType;
  static constexpr OperationType PUT =
    KVOperation_OperationType_PUT;
  static constexpr OperationType DELETE =
    KVOperation_OperationType_DELETE;
  static constexpr OperationType GET =
    KVOperation_OperationType_GET;
  static inline bool OperationType_IsValid(int value) {
    return KVOperation_OperationType_IsValid(value);
  }
  static constexpr OperationType OperationType_MIN =
    KVOperation_OperationType_OperationType_MIN;
  static constexpr OperationType OperationType_MAX =
    KVOperation_OperationType_OperationType_MAX;
  static constexpr int OperationType_ARRAYSIZE =
    KVOperation_OperationType_OperationType_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  OperationType_descriptor() {
    return KVOperation_OperationType_descriptor();
  }
  template<typename T>
  static inline const std::string& OperationType_Name(T enum_t_value) {
    ...
    return KVOperation_OperationType_Name(enum_t_value);
  }
  static inline bool OperationType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      OperationType* value) {
    return KVOperation_OperationType_Parse(name, value);
  }
  ...
  void clear_op_type();
  ::embkv::KVOperation_OperationType op_type() const;
  void set_op_type(::embkv::KVOperation_OperationType value);
  private:
  ::embkv::KVOperation_OperationType _internal_op_type() const;
  void _internal_set_op_type(::embkv::KVOperation_OperationType value);
  public:

  // @@protoc_insertion_point(class_scope:embkv.KVOperation)
 private:
  class _Internal;
...
inline ::embkv::RequestVoteRequest* Message::release_request_vote_request() {
  ...
  if (_internal_has_request_vote_request()) {
    clear_has_content();
    ::embkv::RequestVoteRequest* temp = content_.request_vote_request_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    content_.request_vote_request_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::embkv::RequestVoteRequest& Message::_internal_request_vote_request() const {
  return _internal_has_request_vote_request()
      ? *content_.request_vote_request_
...
inline void Message::unsafe_arena_set_allocated_request_vote_request(::embkv::RequestVoteRequest* request_vote_request) {
  ...
  if (request_vote_request) {
    ...
    content_.request_vote_request_ = request_vote_request;
  }
...
inline ::embkv::RequestVoteRequest* Message::_internal_mutable_request_vote_request() {
  if (!_internal_has_request_vote_request()) {
    clear_content();
    set_has_request_vote_request();
    content_.request_vote_request_ = CreateMaybeMessage< ::embkv::RequestVoteRequest >(GetArenaForAllocation());
  }
  return content_.request_vote_request_;
}
...
inline ::embkv::RequestVoteResponse* Message::release_request_vote_response() {
  ...
  if (_internal_has_request_vote_response()) {
    clear_has_content();
    ::embkv::RequestVoteResponse* temp = content_.request_vote_response_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    content_.request_vote_response_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::embkv::RequestVoteResponse& Message::_internal_request_vote_response() const {
  return _internal_has_request_vote_response()
      ? *content_.request_vote_response_
...
inline void Message::unsafe_arena_set_allocated_request_vote_response(::embkv::RequestVoteResponse* request_vote_response) {
  ...
  if (request_vote_response) {
    ...
    content_.request_vote_response_ = request_vote_response;
  }
...
inline ::embkv::RequestVoteResponse* Message::_internal_mutable_request_vote_response() {
  if (!_internal_has_request_vote_response()) {
    clear_content();
    set_has_request_vote_response();
    content_.request_vote_response_ = CreateMaybeMessage< ::embkv::RequestVoteResponse >(GetArenaForAllocation());
  }
  return content_.request_vote_response_;
}
...
inline void Message::clear_append_entries_request() {
  if (_internal_has_append_entries_request()) {
    if (GetArenaForAllocation() == nullptr) {
      delete content_.append_entries_request_;
    }
    clear_has_content();
  }
}
inline ::embkv::AppendEntriesRequest* Message::release_append_entries_request() {
  ...
  if (_internal_has_append_entries_request()) {
    clear_has_content();
    ::embkv::AppendEntriesRequest* temp = content_.append_entries_request_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    content_.append_entries_request_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::embkv::AppendEntriesRequest& Message::_internal_append_entries_request() const {
  return _internal_has_append_entries_request()
      ? *content_.append_entries_request_
...
inline void Message::unsafe_arena_set_allocated_append_entries_request(::embkv::AppendEntriesRequest* append_entries_request) {
  ...
  if (append_entries_request) {
    ...
    content_.append_entries_request_ = append_entries_request;
  }
...
inline ::embkv::AppendEntriesRequest* Message::_internal_mutable_append_entries_request() {
  if (!_internal_has_append_entries_request()) {
    clear_content();
    set_has_append_entries_request();
    content_.append_entries_request_ = CreateMaybeMessage< ::embkv::AppendEntriesRequest >(GetArenaForAllocation());
  }
  return content_.append_entries_request_;
}
...
inline void Message::clear_append_entries_response() {
  if (_internal_has_append_entries_response()) {
    if (GetArenaForAllocation() == nullptr) {
      delete content_.append_entries_response_;
    }
    clear_has_content();
  }
}
inline ::embkv::AppendEntriesResponse* Message::release_append_entries_response() {
  ...
  if (_internal_has_append_entries_response()) {
    clear_has_content();
    ::embkv::AppendEntriesResponse* temp = content_.append_entries_response_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    content_.append_entries_response_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::embkv::AppendEntriesResponse& Message::_internal_append_entries_response() const {
  return _internal_has_append_entries_response()
      ? *content_.append_entries_response_
...
inline void Message::unsafe_arena_set_allocated_append_entries_response(::embkv::AppendEntriesResponse* append_entries_response) {
  ...
  if (append_entries_response) {
    ...
    content_.append_entries_response_ = append_entries_response;
  }
...
inline ::embkv::AppendEntriesResponse* Message::_internal_mutable_append_entries_response() {
  if (!_internal_has_append_entries_response()) {
    clear_content();
    set_has_append_entries_response();
    content_.append_entries_response_ = CreateMaybeMessage< ::embkv::AppendEntriesResponse >(GetArenaForAllocation());
  }
  return content_.append_entries_response_;
}
...
inline void Message::clear_snapshot_request() {
  if (_internal_has_snapshot_request()) {
    if (GetArenaForAllocation() == nullptr) {
      delete content_.snapshot_request_;
    }
    clear_has_content();
  }
}
inline ::embkv::InstallSnapshotRequest* Message::release_snapshot_request() {
  ...
  if (_internal_has_snapshot_request()) {
    clear_has_content();
    ::embkv::InstallSnapshotRequest* temp = content_.snapshot_request_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    content_.snapshot_request_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline void Message::unsafe_arena_set_allocated_snapshot_request(::embkv::InstallSnapshotRequest* snapshot_request) {
  ...
  if (snapshot_request) {
    ...
    content_.snapshot_request_ = snapshot_request;
  }
...
inline ::embkv::InstallSnapshotRequest* Message::_internal_mutable_snapshot_request() {
  if (!_internal_has_snapshot_request()) {
    clear_content();
    set_has_snapshot_request();
    content_.snapshot_request_ = CreateMaybeMessage< ::embkv::InstallSnapshotRequest >(GetArenaForAllocation());
  }
  return content_.snapshot_request_;
}
...
inline ::embkv::InstallSnapshotResponse* Message::release_snapshot_response() {
  ...
  if (_internal_has_snapshot_response()) {
    clear_has_content();
    ::embkv::InstallSnapshotResponse* temp = content_.snapshot_response_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    content_.snapshot_response_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline void Message::unsafe_arena_set_allocated_snapshot_response(::embkv::InstallSnapshotResponse* snapshot_response) {
  ...
  if (snapshot_response) {
    ...
    content_.snapshot_response_ = snapshot_response;
  }
...
inline ::embkv::InstallSnapshotResponse* Message::_internal_mutable_snapshot_response() {
  if (!_internal_has_snapshot_response()) {
    clear_content();
    set_has_snapshot_response();
    content_.snapshot_response_ = CreateMaybeMessage< ::embkv::InstallSnapshotResponse >(GetArenaForAllocation());
  }
  return content_.snapshot_response_;
}
...
inline ::embkv::ClientRequest* Message::release_client_request() {
  ...
  if (_internal_has_client_request()) {
    clear_has_content();
    ::embkv::ClientRequest* temp = content_.client_request_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    content_.client_request_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline void Message::unsafe_arena_set_allocated_client_request(::embkv::ClientRequest* client_request) {
  ...
  if (client_request) {
    ...
    content_.client_request_ = client_request;
  }
...
inline ::embkv::ClientRequest* Message::_internal_mutable_client_request() {
  if (!_internal_has_client_request()) {
    clear_content();
    set_has_client_request();
    content_.client_request_ = CreateMaybeMessage< ::embkv::ClientRequest >(GetArenaForAllocation());
  }
  return content_.client_request_;
}
...
inline ::embkv::ClientResponse* Message::release_client_response() {
  ...
  if (_internal_has_client_response()) {
    clear_has_content();
    ::embkv::ClientResponse* temp = content_.client_response_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    content_.client_response_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline void Message::unsafe_arena_set_allocated_client_response(::embkv::ClientResponse* client_response) {
  ...
  if (client_response) {
    ...
    content_.client_response_ = client_response;
  }
...
inline ::embkv::ClientResponse* Message::_internal_mutable_client_response() {
  if (!_internal_has_client_response()) {
    clear_content();
    set_has_client_response();
    content_.client_response_ = CreateMaybeMessage< ::embkv::ClientResponse >(GetArenaForAllocation());
  }
  return content_.client_response_;
}
...
void EntryMeta::set_client_request(ArgT0&& arg0, ArgT... args) {
 ...
 client_request_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void EntryMeta::set_allocated_client_request(std::string* client_request) {
  ...
  client_request_.SetAllocated(client_request, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (client_request_.IsDefault()) {
    client_request_.Set("", GetArenaForAllocation());
  }
...
void InstallSnapshotRequest::set_snapshot_data(ArgT0&& arg0, ArgT... args) {
 ...
 snapshot_data_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void InstallSnapshotRequest::_internal_set_snapshot_data(const std::string& value) {
  ...
  snapshot_data_.Set(value, GetArenaForAllocation());
}
inline std::string* InstallSnapshotRequest::_internal_mutable_snapshot_data() {
  
  return snapshot_data_.Mutable(GetArenaForAllocation());
}
...
inline void InstallSnapshotRequest::set_allocated_snapshot_data(std::string* snapshot_data) {
  ...
  snapshot_data_.SetAllocated(snapshot_data, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (snapshot_data_.IsDefault()) {
    snapshot_data_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
inline const std::string& ClientResponse::value() const {
  // @@protoc_insertion_point(field_get:embkv.ClientResponse.value)
...
void ClientResponse::set_value(ArgT0&& arg0, ArgT... args) {
 ...
 value_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:embkv.ClientResponse.value)
}
inline std::string* ClientResponse::mutable_value() {
  std::string* _s = _internal_mutable_value();
  // @@protoc_insertion_point(field_mutable:embkv.ClientResponse.value)
  return _s;
}
...
inline std::string* ClientResponse::release_value() {
  // @@protoc_insertion_point(field_release:embkv.ClientResponse.value)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:embkv.ClientResponse.value)
}

// optional string error = 5;
inline bool ClientResponse::_internal_has_error() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
...
inline const std::string& ClientResponse::error() const {
  // @@protoc_insertion_point(field_get:embkv.ClientResponse.error)
  return _internal_error();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void ClientResponse::set_error(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 error_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:embkv.ClientResponse.error)
}
inline std::string* ClientResponse::mutable_error() {
  std::string* _s = _internal_mutable_error();
  // @@protoc_insertion_point(field_mutable:embkv.ClientResponse.error)
  return _s;
}
...
inline std::string* ClientResponse::release_error() {
  // @@protoc_insertion_point(field_release:embkv.ClientResponse.error)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:embkv.ClientResponse.error)
}
...
// .embkv.KVOperation.OperationType op_type = 1;
inline void KVOperation::clear_op_type() {
  op_type_ = 0;
}
inline ::embkv::KVOperation_OperationType KVOperation::_internal_op_type() const {
  return static_cast< ::embkv::KVOperation_OperationType >(op_type_);
}
inline ::embkv::KVOperation_OperationType KVOperation::op_type() const {
  // @@protoc_insertion_point(field_get:embkv.KVOperation.op_type)
  return _internal_op_type();
}
inline void KVOperation::_internal_set_op_type(::embkv::KVOperation_OperationType value) {
  
  op_type_ = value;
}
inline void KVOperation::set_op_type(::embkv::KVOperation_OperationType value) {
  _internal_set_op_type(value);
  // @@protoc_insertion_point(field_set:embkv.KVOperation.op_type)
}

// string key = 2;
inline void KVOperation::clear_key() {
  key_.ClearToEmpty();
}
inline const std::string& KVOperation::key() const {
  // @@protoc_insertion_point(field_get:embkv.KVOperation.key)
  return _internal_key();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void KVOperation::set_key(ArgT0&& arg0, ArgT... args) {
 
 key_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:embkv.KVOperation.key)
}
inline std::string* KVOperation::mutable_key() {
  std::string* _s = _internal_mutable_key();
  // @@protoc_insertion_point(field_mutable:embkv.KVOperation.key)
  return _s;
}
inline const std::string& KVOperation::_internal_key() const {
  return key_.Get();
}
inline void KVOperation::_internal_set_key(const std::string& value) {
  
  key_.Set(value, GetArenaForAllocation());
}
inline std::string* KVOperation::_internal_mutable_key() {
  
  return key_.Mutable(GetArenaForAllocation());
}
inline std::string* KVOperation::release_key() {
  // @@protoc_insertion_point(field_release:embkv.KVOperation.key)
  return key_.Release();
}
inline void KVOperation::set_allocated_key(std::string* key) {
  if (key != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:embkv.KVOperation.key)
}

// string value = 3;
inline void KVOperation::clear_value() {
  value_.ClearToEmpty();
}
inline const std::string& KVOperation::value() const {
  // @@protoc_insertion_point(field_get:embkv.KVOperation.value)
  return _internal_value();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void KVOperation::set_value(ArgT0&& arg0, ArgT... args) {
 
 value_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:embkv.KVOperation.value)
}
inline std::string* KVOperation::mutable_value() {
  std::string* _s = _internal_mutable_value();
  // @@protoc_insertion_point(field_mutable:embkv.KVOperation.value)
  return _s;
}
inline const std::string& KVOperation::_internal_value() const {
  return value_.Get();
}
inline void KVOperation::_internal_set_value(const std::string& value) {
  
  value_.Set(value, GetArenaForAllocation());
}
inline std::string* KVOperation::_internal_mutable_value() {
  
  return value_.Mutable(GetArenaForAllocation());
}
inline std::string* KVOperation::release_value() {
  // @@protoc_insertion_point(field_release:embkv.KVOperation.value)
  return value_.Release();
}
inline void KVOperation::set_allocated_value(std::string* value) {
  if (value != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:embkv.KVOperation.value)
}
...
template <> struct is_proto_enum< ::embkv::KVOperation_OperationType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::embkv::KVOperation_OperationType>() {
  return ::embkv::KVOperation_OperationType_descriptor();
}
