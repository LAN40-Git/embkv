...
const uint32_t TableStruct_rpc_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::embkv::ClientResponse, _impl_.result_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 101, -1, -1, sizeof(::embkv::ClientResponse)},
};
...
const char descriptor_table_protodef_rpc_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ".embkv.RequestVoteRequestH\000\0228\n\022request_v"
  "ote_reply\030\004 \001(\0132\032.embkv.RequestVoteRespo"
  "nseH\000\022=\n\026append_entries_request\030\005 \001(\0132\033."
  "embkv.AppendEntriesRequestH\000\022<\n\024append_e"
  "ntries_reply\030\006 \001(\0132\034.embkv.AppendEntries"
  "ResponseH\000\0229\n\020snapshot_request\030\007 \001(\0132\035.e"
  "mbkv.InstallSnapshotRequestH\000\0228\n\016snapsho"
  "t_reply\030\010 \001(\0132\036.embkv.InstallSnapshotRes"
  "ponseH\000\022.\n\016client_request\030\t \001(\0132\024.embkv."
  "ClientRequestH\000\022-\n\014client_reply\030\n \001(\0132\025."
  "embkv.ClientResponseH\000B\t\n\007content\"@\n\tEnt"
  "ryMeta\022\014\n\004term\030\001 \001(\004\022\r\n\005index\030\002 \001(\004\022\026\n\016c"
  "lient_request\030\003 \001(\014\"Q\n\022RequestVoteReques"
  "t\022\014\n\004term\030\001 \001(\004\022\026\n\016last_log_index\030\002 \001(\004\022"
  "\025\n\rlast_log_term\030\003 \001(\004\"4\n\023RequestVoteRes"
  "ponse\022\014\n\004term\030\001 \001(\004\022\017\n\007granted\030\002 \001(\010\"\243\001\n"
  "\024AppendEntriesRequest\022\014\n\004term\030\001 \001(\004\022\026\n\016p"
  "rev_log_index\030\002 \001(\004\022\025\n\rprev_log_term\030\003 \001"
  "(\004\022!\n\007entries\030\004 \003(\0132\020.embkv.EntryMeta\022\025\n"
  "\rleader_commit\030\005 \001(\004\022\024\n\014is_heartbeat\030\006 \001"
  "(\010\"f\n\025AppendEntriesResponse\022\014\n\004term\030\001 \001("
  "\004\022\017\n\007success\030\002 \001(\010\022\026\n\016conflict_index\030\003 \001"
  "(\004\022\026\n\016last_log_index\030\004 \001(\004\"U\n\026InstallSna"
  "pshotRequest\022\014\n\004term\030\001 \001(\004\022\026\n\016snapshot_i"
  "ndex\030\002 \001(\004\022\025\n\rsnapshot_data\030\003 \001(\014\"*\n\027Ins"
  "tallSnapshotResponse\022\017\n\007success\030\001 \001(\010\"4\n"
  "\rClientRequest\022\022\n\nrequest_id\030\001 \001(\004\022\017\n\007co"
  "mmand\030\002 \001(\014\"Z\n\016ClientResponse\022\022\n\nrequest"
  "_id\030\001 \001(\004\022\023\n\013leader_hint\030\002 \001(\004\022\017\n\007succes"
...
const ::_pbi::DescriptorTable descriptor_table_rpc_2eproto = {
    false, false, 1391, descriptor_table_protodef_rpc_2eproto,
    "rpc.proto",
...
class Message::_Internal {
 public:
  ...
  static const ::embkv::RequestVoteResponse& request_vote_reply(const Message* msg);
  static const ::embkv::AppendEntriesRequest& append_entries_request(const Message* msg);
  static const ::embkv::AppendEntriesResponse& append_entries_reply(const Message* msg);
  static const ::embkv::InstallSnapshotRequest& snapshot_request(const Message* msg);
  static const ::embkv::InstallSnapshotResponse& snapshot_reply(const Message* msg);
  static const ::embkv::ClientRequest& client_request(const Message* msg);
  static const ::embkv::ClientResponse& client_reply(const Message* msg);
};
...
Message::_Internal::request_vote_reply(const Message* msg) {
  return *msg->_impl_.content_.request_vote_reply_;
}
...
void Message::set_allocated_request_vote_reply(::embkv::RequestVoteResponse* request_vote_reply) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_content();
  if (request_vote_reply) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(request_vote_reply);
    if (message_arena != submessage_arena) {
      request_vote_reply = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, request_vote_reply, submessage_arena);
    }
    set_has_request_vote_reply();
    _impl_.content_.request_vote_reply_ = request_vote_reply;
  }
  // @@protoc_insertion_point(field_set_allocated:embkv.Message.request_vote_reply)
}
...
void Message::set_allocated_append_entries_reply(::embkv::AppendEntriesResponse* append_entries_reply) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_content();
...
void Message::set_allocated_snapshot_reply(::embkv::InstallSnapshotResponse* snapshot_reply) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_content();
  if (snapshot_reply) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
void Message::set_allocated_client_reply(::embkv::ClientResponse* client_reply) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  clear_content();
  if (client_reply) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
...
Message::Message(const Message& from)
  ...
  switch (from.content_case()) {
    ...
    case kRequestVoteReply: {
      _this->_internal_mutable_request_vote_reply()->::embkv::RequestVoteResponse::MergeFrom(
          from._internal_request_vote_reply());
      break;
    }
    ...
    case kAppendEntriesReply: {
      _this->_internal_mutable_append_entries_reply()->::embkv::AppendEntriesResponse::MergeFrom(
    ...
    case kSnapshotReply: {
      _this->_internal_mutable_snapshot_reply()->::embkv::InstallSnapshotResponse::MergeFrom(
    ...
    case kClientReply: {
      _this->_internal_mutable_client_reply()->::embkv::ClientResponse::MergeFrom(
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ptr = ctx->ParseMessage(_internal_mutable_request_vote_reply(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Message::_InternalSerialize(
  ...
  if (_internal_has_request_vote_reply()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(4, _Internal::request_vote_reply(this),
        _Internal::request_vote_reply(this).GetCachedSize(), target, stream);
  }
